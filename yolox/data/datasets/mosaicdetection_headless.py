...
import torch
from yolox.utils.boxes import xywh2cxcywh
...
from ..data_augment_headless import random_perspective_with_angles
...
class MosaicHeadLessDetection(Dataset):
    ...
    def __init__(
        ...
        enable_mixup=True, mosaic_prob=1.0, mixup_prob=1.0, num_angles=180, *args
    ):
        """
        ...
        self.enable_rotated = True
        self.rotated_prob = 0.5
