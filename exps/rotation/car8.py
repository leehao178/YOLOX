...
from exps.example.rotation.yolox_headorder_base import BaseHeadOrderExp as MyExp
...
class Exp(MyExp):
    ...
    def get_evaluator(self, batch_size, is_distributed, testdev=False, legacy=False):
        from yolox.evaluators import Car8HeadOrderEvaluator

        val_loader = self.get_eval_loader(batch_size, is_distributed, testdev, legacy)
        evaluator = Car8HeadOrderEvaluator(
