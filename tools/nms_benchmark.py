...
from yolox.evaluators import evaluation ,mergebypoly, evaluation_trans, draw_DOTA_image, evaluation2
...
def main(exp, args):
    ...
    if args.mode == 'val':
        ...
        evaluation2(
                    detoutput=detection,
                    imageset=r'/home/aimlusr/dataset/nms/val/images', # 原始未裁切圖片
                    annopath=r'/home/aimlusr/dataset/nms/val/labelTxt/{:s}.txt',
                    classnames=CLASSES,
                    t0=t0
                )
...
if __name__ == "__main__":
    ...
    if args.mode == 'test':
        args.path = '/home/aimlusr/dataset/nms/val_split/images'
    # elif args.mode == 'val':
